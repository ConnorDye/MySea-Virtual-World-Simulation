...
public class conqueredAtlantis extends AnimationEntity {
    public static final int ATLANTIS_ANIMATION_REPEAT_COUNT = 7;
    //NOT USED
    //private int resourceLimit;
    //private int resourceCount;

    public conqueredAtlantis(String id, Point position, List<PImage> images, int resourceLimit, int resourceCount,
    ...
    public static conqueredAtlantis createAtlantis(String id, Point position,
                                          List<PImage> images)
    {
        return new conqueredAtlantis(id, position, images,
                0, 0, 0, 0);
    }
